...
export default function SignupForm({ onSwitchToLogin, onSuccess, onGoHome }: SignupFormProps) {
    ...
    <div className="min-h-screen flex items-center justify-center section-pad py-20">
      <div className="w-full max-w-[400px]">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-body text-muted-foreground">Join EdgeLearn AI</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="name" className="block text-label text-foreground mb-2">
              Name
            </label>
            <Input
              id="name"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-label text-foreground mb-2">
              Confirm password
            </label>
            <Input
              id="confirmPassword"
